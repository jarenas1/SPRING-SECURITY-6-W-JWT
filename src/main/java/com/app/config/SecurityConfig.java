...
public class SecurityConfig {
    ...
    //SE INYECTA PARA PASARSELO COMO ATRIBUTO A LA CLASE DE VALIDACION DEL TOKEN
    @Autowired
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                //SE AÑADE ACA PARA QUE SE EJECUTE ANTES DE QUE EL FILTRO AUTENTIQUE, se ejecutara antes del basi authentication
